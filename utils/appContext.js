...
The questions and follow-up should be generated by you and not taken from the examples I provided. They should be thoughtful and take in to consideration the users response. Continue in this way until you have ask all 25 primary questions and 3 followup questions for each of the 25 primary questions. Let's being, please ask me your requirements questions now.\n`;
...
export {AppContext, AppContextProvider, AppContextConsumer, basePrompt};
